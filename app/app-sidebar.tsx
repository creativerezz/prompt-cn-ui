    ...
    if (isMobileView) {
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetOverlay className="top-16" />
          <SheetContent
            data-sidebar="sidebar"
            data-mobile="true"
            className="bg-sidebar text-sidebar-foreground border-sidebar-border top-16 bottom-3 left-3 h-[calc(100svh-5.25rem)] w-(--sidebar-width) rounded-xl border p-0 shadow-2xl [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col overflow-hidden group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:border group-data-[variant=floating]:shadow-[0_24px_80px_-32px_rgb(0_0_0/0.85),0_1px_0_rgb(255_255_255/0.03)_inset]"
          >
            {children}
          </div>
        </div>
