  ...
  return (
    <div
      className={cn(
        ...
        "prose-code:bg-muted prose-code:text-foreground prose-code:block prose-code:rounded-md prose-code:p-1 prose-table:block prose-table:overflow-y-auto prose-img:m-0 mr-0 max-w-full min-w-0 flex-1",
